...
1. Change the second element in the `languages` array to `"Python"`.
```js
const languages = ["JavaScript", "C++", "Ruby"];
// Expected result: ["JavaScript", "Python", "Ruby"]

```
2. Add and remove elements using array methods:

  - Add "Pluto" to the end and "Sun" to the beginning of the planets array.

  - Then remove the second element of the array.

```js
const planets = ["Mercury", "Venus", "Earth"];
// Expected: ["Sun", "Mercury","Venus", "Earth", "Pluto"]
// After removing second element: ["Sun", "Venus","Earth", "Pluto"]


```
3. Combine two arrays and create a string:
   - Combine both arrays below into one array and then convert it to a string separated by `-`.

 ```js
 const first = ["HTML", "CSS"];
const second = ["JavaScript", "React"];
// Expected output: "HTML-CSS-JavaScript-React"
